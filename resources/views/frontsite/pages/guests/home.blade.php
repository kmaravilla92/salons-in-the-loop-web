	...
	<section id="main-wrapper" class="homepage">
		...
		<div class="explore-section section">
			...
			<div class="wrapper">
				<div class="listing-holder ">
					...
					<a class="market-holder">
						<img src="/frontsite/images/get-salon-help.png" alt="Get Salon Help">
						<div class="content-holder ease">
							<h5 class="">Get Salon Help</h5>
						</div>
					</a>
					<a class="market-holder">
					...
					<a class="market-holder">
						<img src="/frontsite/images/mobile-business.png" alt="Mobile Business">
						<div class="content-holder ease">
							<h5 class="">Mobile Business</h5>
						</div>
					</a>
		...
		<div class="waiting-works popup-section">
			...
			<div class="half-width f-right">
				<div class="content center-div">
					...
					<a href="#" class="btn btn-violet">Search now!</a>
				</div>
			</div>
		</div>
		<div class="waiting-works send-section">
			<div class="half-width f-left">
				<div class="content center-div">
					...
					<a href="#" class="btn btn-red">Help Request</a>
					<a href="#" class="btn btn-violet">Watch how it works</a>
				</div>
			</div>
			<div class="half-width f-right">
		...
		<div class="get-connected section">
			<div class="content-holder">
				...
				<a href="#" class="btn btn-violet">Create Your Account Now!</a>
			</div>
		</div>
	</section>
@endsection