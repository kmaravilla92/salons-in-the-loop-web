...
try {
    ...
    require('../../../public/frontsite/js/lib/jquery-ui.min.js');
	window.jquery_ui;
	require('../../../public/frontsite/js/select2.full.min.js');
	require('../../../public/frontsite/js/jquery.magnific-popup.min.js');
